...
async function setupCl() {
  ...
  // Fallback: walk the standard VS install roots directly. Some installs
  // (e.g. VS Community without the standalone Installer package) have no
  // vswhere at the "guaranteed" path.
  const vsRoots = [
