...
- [PaddleOCR-VL-1.6](https://huggingface.co/PaddlePaddle/PaddleOCR-VL-1.6) para reconhecimento de texto por OCR
...
| `PaddleOCR-VL-1.6`           | modelo de linguagem visual  | lê texto recortado em tokens de texto                     |
